    ...
    public class TenantManagementController : BaseController
    {
            ...
            NpgsqlTransaction transaction)
        {
            ...
            return new
            {
                ...
                BaseRate = reader.IsDBNull(11) ? null : reader.GetDecimal(11),
                Threshold1 = reader.IsDBNull(12) ? null : reader.GetDecimal(12),
                Threshold1Rate = reader.IsDBNull(13) ? null : reader.GetDecimal(13),
                Threshold2 = reader.IsDBNull(14) ? null : reader.GetDecimal(14),
                Threshold2Rate = reader.IsDBNull(15) ? null : reader.GetDecimal(15),
                ...
                Deposit = reader.IsDBNull(18) ? null : reader.GetDecimal(18),
